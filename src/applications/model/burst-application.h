 ...
 * \defgroup burst BurstApplication
 *
 * TODO fix doc
...
public:
  ...
  uint32_t GetPktsPerBurst (void) const;
...
private:
  ...
  Ptr<RandomVariableStream>  m_burstsPerSecond;       //!< rng for On Time
