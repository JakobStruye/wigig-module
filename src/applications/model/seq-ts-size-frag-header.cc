...
SeqTsSizeFragHeader::SeqTsSizeFragHeader () : E2eStatsHeader ()
{
...
SeqTsSizeFragHeader::Print (std::ostream &os) const
{
  ...
  E2eStatsHeader::Print (os);
}

uint32_t
SeqTsSizeFragHeader::GetSerializedSize (void) const
{
  return E2eStatsHeader::GetSerializedSize () + 4;
}
