...
//                    DmgWifiChannel channel = wifiChannel.Create();
...
//                               "BeaconInterval", TimeValue (MicroSeconds (102400)),
                ...
                /**** DmgWifiHelper is a meta-helper: it helps creates helpers ****/
//                    DmgWifiHelper wifi2;
//                    wifi2.SetStandard(wifiStandard);
//
//                    /**** Set up Channel ****/
...
//
//                    /* Set operating channel */
//                    wifiPhy2.Set("ChannelNumber", UintegerValue(config.chNumber));
//                    wifiPhy2.Set("PrimaryChannelNumber", UintegerValue(config.primayChannel));
//                    /* Add support for the OFDM PHY */
...
//                /* Set Analytical Codebook for the WiGig Devices */
//                wifi2.SetCodebook("ns3::CodebookAnalytical",
//                                 "CodebookType", EnumValue(SIMPLE_CODEBOOK),
//                                 "Antennas", UintegerValue(1),
//                                 "Sectors", UintegerValue(8));
//                    /* Create Wifi Network Devices (WifiNetDevice) */
              ...
              std::cout << "stopping " << mode << " " << mcs << " " << channelIdx << " TIME " << (std::chrono::duration_cast<std::chrono::microseconds>(stop - start)).count() / 1000000.0 << std::endl;
